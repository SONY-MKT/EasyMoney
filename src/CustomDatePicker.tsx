        ...
        {isOpen && (
            <div className={`fixed inset-0 z-[200] flex ${isMobile ? 'items-end' : 'items-center justify-center p-4'} font-sans`}>
              ...
              <motion.div 
                 ...
                 className={`relative w-full overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.4)] ${isMobile ? 'bg-white rounded-t-[32px] rounded-b-none pb-safe' : 'bg-white max-w-[360px] rounded-[32px]'}`}
              >
